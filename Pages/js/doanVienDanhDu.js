...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const viewChonDV = document.getElementById('view-chon-dv');
    const viewXacNhan = document.getElementById('view-xac-nhan');
    const btnShowXacNhan = document.getElementById('btn-show-xac-nhan');
    const btnQuayLai = document.getElementById('btn-quay-lai-chon-dv');
    
    // Khi nhấn nút "ĐOÀN VIÊN DANH DỰ"
    btnShowXacNhan.addEventListener('click', function() {
        const selectedCheckboxes = viewChonDV.querySelectorAll('.dv-checkbox:checked');
        ...
        const confirmListBody = document.getElementById('xac-nhan-list-body');
